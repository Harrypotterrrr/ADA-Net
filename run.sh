...
#
# Meta-learning (Ours)
CUDA_VISIBLE_DEVICES='0' python3 train_meta_learning.py --save-path "results/principled-meta-learning-labels4000-epsilon1e-2-lr0.1-mile150-ilr0.1-inile150-type0-label3-auto-weight" \
                                                        --use-label \
                                                        --auto-weight \
                                                        --unlabel-weight "3." \
                                                        --total-steps "200000" \
